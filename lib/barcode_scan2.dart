...
class BarcodeScan2 extends StatefulWidget {
  const BarcodeScan2({super.key});
  @override
  State<BarcodeScan2> createState() => _BarcodeScan2State();
}

class _BarcodeScan2State extends State<BarcodeScan2> {
